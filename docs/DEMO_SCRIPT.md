...
5. Select **Prepare speech runtime**, grant microphone access if appropriate, and wait for ready provider/capture status. Select **Test speakers** and personally confirm audibility.
...
| 0:20 | Call **Rina Shah** and select **Prepare speech runtime** if the hearing has not connected yet. | Point out that the production courtroom is voice-first and has no text composer. |
