...
export const CASE_COMPILER_PROMPT_VERSION = "case-compiler.prompt.v3" as const;
export const CASE_COMPILER_OUTPUT_SCHEMA_VERSION = "case-compiler.output.v3" as const;
export const CASE_COMPILER_VALIDATION_SCHEMA_VERSION = "case-compiler.validation.v3" as const;
export const CASE_COMPILER_PROVIDER_PROTOCOL_VERSION = "case-compiler.provider.v1" as const;
export const CASE_COMPILER_SCHEMA_NAME = "suits_case_compiler_v3" as const;
export const CASE_COMPILER_PROMPT_CACHE_KEY = "suits.case-compiler.v3" as const;
