...
const INTERNAL_ERROR_STATUS = new Map<string, number>([
  ...
  ["FINAL_BOUND_INTERRUPTION_STALE", 409],
  ["FINAL_BOUND_INTERRUPTION_CONFLICT", 409],
  ["FINAL_BOUND_INTERRUPTION_INVALID", 422],
  ["FINAL_BOUND_INTERRUPTION_CLAIM_STALE", 409],
  ["FINAL_BOUND_INTERRUPTION_CLAIM_REQUIRED", 409],
  ["FINAL_BOUND_INTERRUPTION_CLAIM_INVALID", 422],
  ["COURTROOM_MODEL_CALL_CONFLICT", 409],
  ["COURTROOM_MODEL_CALL_TRACE_INVALID", 422],
  ["COURT_RECORDS_TRIAL_LIMIT_EXCEEDED", 409],
  ["HEARING_AUDIO_AUDIT_CONFLICT", 409],
  ["HEARING_AUDIO_AUDIT_LIMIT_EXCEEDED", 409],
  ["HEARING_AUDIO_AUDIT_RECORD_INVALID", 422],
  ["HEARING_AUDIO_AUDIT_SEMANTICS_INVALID", 422],
